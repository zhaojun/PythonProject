...
for file1 in FileStore:
    ...
    if missing_foods:
        ...
        # 创建 ExcelWriter 对象
        with pd.ExcelWriter(r'C:\Users\Administrator\Desktop\菜品贴纸打印-更新.xlsx', engine='openpyxl', mode='w') as writer:
            # 获取所有表名
        ...
        print(f'已将 {len(missing_foods)} 个缺失的菜品添加到"全部菜品"工作表中，请在价格列中填写价格。')
        print('缺失的菜品：')
